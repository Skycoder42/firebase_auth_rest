...
class RestApi {
  ...
  ) async => AnonymousSignInResponse.fromJson(
    await _post(_buildUri('accounts:signUp'), request.toJson()),
  );

  /// https://firebase.google.com/docs/reference/rest/auth#section-create-email-password
  Future<PasswordSignInResponse> signUpWithPassword(
    PasswordSignInRequest request,
  ) async => PasswordSignInResponse.fromJson(
    await _post(_buildUri('accounts:signUp'), request.toJson()),
  );
  ...
  Future<IdpSignInResponse> signInWithIdp(IdpSignInRequest request) async =>
      IdpSignInResponse.fromJson(
        await _post(_buildUri('accounts:signInWithIdp'), request.toJson()),
      );
  ...
  Future<PasswordSignInResponse> signInWithPassword(
    ...
    await _post(_buildUri('accounts:signInWithPassword'), request.toJson()),
  );

  /// https://firebase.google.com/docs/reference/rest/auth#section-verify-custom-token
  Future<CustomTokenSignInResponse> signInWithCustomToken(
    CustomTokenSignInRequest request,
  ) async => CustomTokenSignInResponse.fromJson(
    await _post(_buildUri('accounts:signInWithCustomToken'), request.toJson()),
  );

  /// https://firebase.google.com/docs/reference/rest/auth#section-get-account-info
  Future<UserDataResponse> getUserData(UserDataRequest request) async =>
      UserDataResponse.fromJson(
        await _post(_buildUri('accounts:lookup'), request.toJson()),
      );
  ...
  Future<EmailUpdateResponse> updateEmail(
    ...
    String? locale,
  ]) async => EmailUpdateResponse.fromJson(
    await _post(
  ...
  ) async => PasswordUpdateResponse.fromJson(
  ...
  Future<OobCodeResponse> sendOobCode(
    ...
    String? locale,
  ]) async => OobCodeResponse.fromJson(
    await _post(
  ...
  ) async => PasswordResetResponse.fromJson(
    await _post(_buildUri('accounts:resetPassword'), request.toJson()),
  );
  ...
  ) async => FetchProviderResponse.fromJson(
    await _post(_buildUri('accounts:createAuthUri'), request.toJson()),
  );
  ...
  Future<void> delete(DeleteRequest request) =>
      _post(_buildUri('accounts:delete'), request.toJson(), noContent: true);
  ...
  Uri _buildUri(
    ...
    return Uri(
      ...
      host: host,
      port: port,
      pathSegments: [if (emulator != null) targetDomain, 'v1', path],
      queryParameters: <String, dynamic>{'key': apiKey, ...?queryParameters},
    );
  }
  ...
  Future<Map<String, dynamic>> _postQuery(
    ...
    return _parseResponse(
      await client.post(url, body: query, headers: allHeaders),
    );
  }
